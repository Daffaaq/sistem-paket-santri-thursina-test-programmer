        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('asrama.edit', $asrama->id_asrama) }}"
                            class="{{ request()->routeIs('asrama.edit') ? 'active' : '' }}">Edit Asrama</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('asrama.update', $asrama->id_asrama) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_asrama" id="nama_asrama" placeholder="Contoh: Al-Azhar"
                            ...
                            value="{{ old('nama_asrama', $asrama->nama_asrama) }}">
                        @error('nama_asrama')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="gedung" id="gedung" placeholder="Contoh: Gedung Putri"
                            ...
                            value="{{ old('gedung', $asrama->gedung) }}">
                        @error('gedung')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
