                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('paket.create') }}"
                            class="{{ request()->routeIs('paket.create') ? 'active' : '' }}">Tambah Paket</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('paket.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_paket" id="nama_paket"
                            ...
                            placeholder="Contoh: Paket Makanan">
                        @error('nama_paket')
                                ...
                                <optgroup label="{{ $namaAsrama }}">
                                    @foreach ($group as $santri)
                                        <option value="{{ $santri->nis }}"
                                            {{ old('penerima_paket') == $santri->nis ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pengirim_paket" id="pengirim_paket"
                            ...
                            value="{{ old('pengirim_paket') }}" placeholder="Contoh: Orang Tua">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="isi_paket_yang_disita" id="isi_paket_yang_disita"
                            ...
                            value="{{ old('isi_paket_yang_disita') }}" placeholder="Contoh: Camilan, Uang">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_paket" id="status_paket"
                            ...
                            <option value="Belum Diambil" {{ old('status_paket') == 'Belum Diambil' ? 'selected' : '' }}>
                                Belum Diambil</option>
                            <option value="Diambil" {{ old('status_paket') == 'Diambil' ? 'selected' : '' }}>
                                Diambil</option>
                        </select>
                        @error('status_paket')
                            <div class="invalid-feedback">{{ $message }}</div>
