                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('santri.create') }}"
                            class="{{ request()->routeIs('santri.create') ? 'active' : '' }}">Create Santri</a>
                    </li>
                </ol>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('santri.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nis" id="nis" placeholder="Contoh: S12345"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_santri" id="nama_santri" placeholder="Contoh: Ahmad"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" id="alamat" rows="3" class="form-control @error('alamat') is-invalid @enderror"
                            placeholder="Contoh: Jl. Merpati No. 12">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <select name="id_asrama" id="id_asrama"
                            ...
                            @foreach ($asrama as $item)
                                <option value="{{ $item->id_asrama }}"
                                    {{ old('id_asrama') == $item->id_asrama ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="total_paket_diterima" id="total_paket_diterima"
                            ...
                            value="{{ old('total_paket_diterima', 0) }}" min="0">
