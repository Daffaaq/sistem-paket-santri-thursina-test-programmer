...
class PaketMasukExport implements FromCollection, WithHeadings, WithMapping, WithEvents
{
    private $rowNumber = 0;
    ...
    public function collection()
    {
        return Paket::with(['kategoriPaket', 'penerimaPaket.asrama'])
            ->where('status_paket', 'Belum Diambil')
            ->get();
    }
    ...
    // Reset nomor urut setiap kali export dijalankan
